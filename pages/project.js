    ...
    <>
      ...
      >
        ...
        <Flex direction={"column"} marginTop={"10px"}>
          ...
          <Project
            title="Aprim"
            dates="December 2020 - August 2021"
            description={
              "Aprim was a web and game hosting company I created with a friend providing hosting to over 50+ clients. The company is now disolved."
            }
          />
        </Flex>
